...
- [ ] **IN PROGRESS — the 3 remaining COM-fidelity Home features:** Borders Inside-Vertical + Apply-to-Text (run-level w:bdr) · Create-a-Style (mint a named style; NO-FORK but large) · Font Color Gradient (w14:textFill, additive fork translator). Then final Home regression sweep → INSERT tab.
