...
- [ ] **NEXT: 003 P2** (More Columns: spacing/equalWidth + Left/Right unequal + line-between — spike-bounded, T015–T020) → **003 P3** (column break, T021–T026); then 004+ (overlay-retirement / residual-`isBlocked`-layout / paged-test-coverage / M6→gate+pagination-calibration / import-fidelity), then the COMPLETENESS PASS (`docs/bug-hunt/`).
