...
(Paged Render Migration — **Milestone 3**: status bar → real page count). M1+M2 done (archived under
specs/001-paged-render-migration/milestones/). Sequencing is owned by
