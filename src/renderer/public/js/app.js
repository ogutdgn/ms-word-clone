...
(function () {
  ...
  function buildTitleBar() {
    ...
    qat.appendChild(qbtn('undo', 'Undo (Ctrl+Z)', () => (WC.PM && WC.PM.active) ? WC.PM.cmd('undo') : E().exec('undo')));
    qat.appendChild(qbtn('redo', 'Redo (Ctrl+Y)', () => (WC.PM && WC.PM.active) ? WC.PM.cmd('redo') : E().exec('redo')));
